      ...
      <div className="max-w-[594px] gap-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="max-w-[590px] leading-[26px] text-[16px] font-[Inter] text-[#5C6C71] font-400  mt-2 px-2">
            We sent a reset password link to the email address you provided. If
            you didn’t get the email, check your spam folder or{" "}
            <span
              onClick={handleRetry}
              className="font-inter font-semibold text-[18px] leading-[22px] tracking-normal text-center capitalize text-[#7B4C1F] hover:underline transition-none cursor-pointer"
            >
              Try Again
            </span>
            .
