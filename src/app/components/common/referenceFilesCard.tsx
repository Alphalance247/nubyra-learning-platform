...
const ReferenceFilesCard: React.FC<ReferenceFilesCardProps> = ({
  ...
  return (
    <div
      className={`bg-[#F3F0EC] border border-[#D6C8BA] rounded-2xl p-6 flex flex-col lg:flex-row items-center justify-between gap-4 ${className}`}
    >
      ...
      <div className="flex-shrink-0 w-full lg:w-fit">
        <div className="w-full bg-[#FBFAF9] border border-[#F2EDE9] p-2 rounded-2xl">
          <Button
            variant="secondary"
            onClick={onButtonClick}
            className="whitespace-nowrap w-full lg:w-[400px]"
          >
            {buttonText}
          </Button>
        </div>
