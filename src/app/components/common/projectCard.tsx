...
const ProjectCard = ({
  ...
  return (
    <div className="bg-[#F3F0EC] border border-[#D6C8BA] p-8 rounded-2xl">
      <Image width={336} height={162} src={image} alt="project" />
      ...
      <div className="mt-6">
        ...
        <p className="text-[#413B35] text-lg mb-10">
          Project Duration:{" "}
          <span className="font-medium text-[#120A02]">{projectDuration}</span>
        </p>

        <button className="text-base font-semibold text-[#70451C]">
          View Full Details
        </button>
      </div>
    </div>
