...
const PaymentMethodSelector = () => {
  ...
  return (
    <div className="w-[580px] h-[444px] p-6 border border-[#E4E7EC] rounded-[10px] bg-[#F3F0EC] flex flex-col gap-4">
      <div className="w-[322px] h-[36px] font-montserrat font-bold text-[20px] leading-[28px] text-[#120A02] capitalize align-middle">Choose Payment Method</div>
      <div className='w-[360px] h-[24px] font-inter font-semibold text-[16px] leading-[24px] tracking-normal align-middle capitalize text-[#413B35]'>Pay with</div>
      ...
      <p className="w-[532px] h-[88px] font-inter font-normal text-[14px] leading-[22px] text-[#413B35] align-middle">
        This is a one-time payment for your course enrollment. You will be redirected
        to the payment service website. After payment, you’ll access the course from
        your dashboard.
      </p>
      ...
      <Button onClick={() => setShowOverlay(true)} 
        variant="primary" className="w-[532px] h-[56px] flex items-center justify-center gap-[6px]">
            Choose Payment
      </Button>
      {showOverlay && (
        <SuccessOverlay
